...
#Funções para resolver a primeira parte do exercício
...
def linha(tam = 42): #função 'linha' para fazer o tracejado
    return '-' * tam
...
while True:
    ...
    if resposta == 1:
        cabeçalho('\033[1;32mOpção 1\033[m')
    elif resposta == 2:
        cabeçalho('\033[1;32mOpção 2\033[m')
    elif resposta == 3:
